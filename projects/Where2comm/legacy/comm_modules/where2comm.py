...
class Communication(nn.Module):
    ...
    def init_gaussian_filter(self, k_size=5, sigma=1):
        ...
        self.gaussian_filter.bias.data.zero_() # type: ignore
    ...
    def forward(self, batch_confidence_maps, record_len, pairwise_t_matrix):
        ...
        for b in range(B):
            ...
            communication_mask_nodiag[::2] = ones_mask[::2] # ego all 1 when object not at diag line
        ...
        communication_rates = sum(communication_rates)/B # avg batch ego comm rate
        communication_masks = torch.concat(communication_masks, dim=0) # [8,1,100,252]
