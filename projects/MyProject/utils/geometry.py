...
@array_converter(apply_to=('x', 'flow', ))
def cumulative_warp_features(x, flow, spatial_extent, mode='nearest'):
...
@array_converter(apply_to=('x', 'flow', ))
def cumulative_warp_features_reverse(x, flow, spatial_extent, mode='nearest', bev_transform=None):
    """ Warps a sequence of feature maps by accumulating incremental 2d flow.
