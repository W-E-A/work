...
def parse_args():
    ...
    parser.add_argument("--config", default='projects/MyProject/configs/exp_infra.py', help="train config file path")
    parser.add_argument("--job-name", default='work_dirs', help="name of your job")
    parser.add_argument("--node", default='LF_R1A', help="configure training node type and num. [(a/v)-(num)], a strands for a100, v stands for v100. num is the machine num")
    parser.add_argument("--branch", default='', required=True, help="train branch")
    ...
    parser.add_argument('--num-workers',type=int, default=1, help='num workers per gpu')
